...
public interface ITestFileGenerator
{
    ...
    /// </summary>
    /// <param name="request">
    ///     The generation request containing output path, target size, number ranges, duplicate ratio, and
    ...
    ///         </item>
    ///         <item>
    ///             <description>TargetSizeBytes is less than or equal to zero</description>
    ///         </item>
    ///         <item>
    ///             <description>MinNumber is negative</description>
    ///         </item>
    ///         <item>
    ///             <description>MaxNumber is less than MinNumber</description>
    ///         </item>
    ///         <item>
    ///             <description>DuplicateRatioPercent is not between 0 and 100</description>
    ///         </item>
    ///         <item>
    ...
    /// </exception>
    Task GenerateAsync(GeneratorRequest request, IProgress<GeneratorProgress>? progress = null,
